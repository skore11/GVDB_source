...
if ( NOT OPTIX_ROOT_DIR )
  # Default search
  if ( WIN32 )
     set (OPTIX_ROOT_DIR "c:/ProgramData/NVIDIA Corporation/OptiX SDK 4.0.0/" CACHE PATH "Location of OptiX library" FORCE) 
     set (OPTIX_VERSION "4.0.0" )
  else ()
     set (OPTIX_ROOT_DIR "/usr/lib/optix" CACHE PATH "" FORCE)
     set (OPTIX_VERSION "4.0.0" )
  endif()
endif()
...
set ( OK_LIB "0" )
_FIND_FILE ( OPTIX_LIB1 OPTIX_LIB_DIR "optix.1.lib" "liboptix.so.1" OK_LIB )
_FIND_FILE ( OPTIX_LIB2 OPTIX_LIB_DIR "optixu.1.lib" "liboptixu.so.1" OK_LIB )
